...
class MultipleChoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        $multiplechoice  = MultipleChoice::paginate(1);
        $paginatesoal = MultipleChoice::all();

        return view('multiplechoice', compact('multiplechoice', 'paginatesoal'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $multiplechoice->save();
        if ($request->fullUrl() == 'http://127.0.0.1:8000/latihan/html/' . $paginatesoal->last()->id)
            return redirect('/latihan/html/?page=' . $multiplechoice->id);
        else
            return redirect('/latihan/html/?page=' . $multiplechoice->id + 1);
    }
