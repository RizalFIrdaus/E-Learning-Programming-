...
@section('content')
    <div class="container-fluid">
        <form action="/admin/tools/insert" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="my-4 row justify-content-center">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" name="nama" placeholder="Nama Aplikasi" aria-label="Username" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">MATERI</span>
            <div class="col-md-6">
                <input type="text" class="form-control" name="materi" placeholder="Nama Materi" aria-label="Username" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">LINK</span>
            <div class="col-md-6">
                <input type="text" class="form-control" name="link" placeholder="URL Link" aria-label="Username" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
