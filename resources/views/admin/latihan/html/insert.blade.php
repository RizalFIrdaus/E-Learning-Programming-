...
@section('content')
    <div class="container-fluid">
        <form action="/admin/latihan/html/insert" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="my-4 row justify-content-center">
            ...
            <div class="col-md-6">
                <textarea class="form-control" id="desc" name="soal" rows="3" placeholder="Tuliskan soal"></textarea>
              </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">PILIHAN A</span>
            <div class="col-md-6">
                <textarea class="form-control" id="desc" name="pil_a" rows="3" placeholder="Isi Pilihan A"></textarea>
              </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">PILIHAN B</span>
            <div class="col-md-6">
                <textarea class="form-control" id="desc" name="pil_b" rows="3" placeholder="Isi Pilihan B"></textarea>
              </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">PILIHAN C</span>
            <div class="col-md-6">
                <textarea class="form-control" id="desc" name="pil_c" rows="3" placeholder="Isi Pilihan C"></textarea>
              </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">PILIHAN D</span>
            <div class="col-md-6">
                <input type="text" class="form-control" name="pil_d" placeholder="Isi Pilihan D" aria-label="Username" aria-describedby="basic-addon1" value="">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
          ...
          <div class="my-4 row justify-content-center">
            <a class="col-md-1 btn btn-danger" href="{{route('mc_latihan_html')}}">Back</a>
            <div class="col-md-6"> 
