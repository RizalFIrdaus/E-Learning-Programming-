...
@section('content')
    <div class="container-fluid">
        <form action="/admin/listlatihan/insert" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="my-4 row justify-content-center">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" name="title" placeholder="Judul" aria-label="Username" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">CHILD TITLE</span>
            <div class="col-md-6">
                <input type="text" class="form-control" name="child_title" placeholder="Title Judul" aria-label="Username" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">URL</span>
            <div class="col-md-6">
                <input type="text" class="form-control" name="url_latihan" placeholder="URL Link" aria-label="Username" aria-describedby="basic-addon1">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
