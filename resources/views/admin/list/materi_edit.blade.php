...
@section('content')
    <div class="container-fluid">
        <form action="/admin/listmateri/{{$materi->id}}" method="post" enctype="multipart/form-data">
          @csrf
          @method('PATCH')
          ...
          <div class="my-4 row justify-content-center">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" name="judul" placeholder="Judul Materi" aria-label="Username" aria-describedby="basic-addon1" value="{{$materi->judul}}">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">TITLE</span>
            <div class="col-md-6">
                <input type="text" class="form-control" name="title" placeholder="Title Judul Materi" aria-label="Username" aria-describedby="basic-addon1" value="{{$materi->title}}">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
            <span class="input-group-text col-md-1" id="basic-addon1">URL</span>
            <div class="col-md-6">
                <input type="text" class="form-control" name="url" placeholder="URL link" aria-label="Username" aria-describedby="basic-addon1" value="{{$materi->url}}">
            </div>
          </div>
          <div class="my-4 row justify-content-center">
